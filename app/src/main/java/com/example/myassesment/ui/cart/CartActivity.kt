package com.example.myassesment.ui.cart
...
import com.example.myassesment.adapter.MyCartAdapter
...
class CartActivity : AppCompatActivity(), CartLoadListener {
    ...
    private fun init(){
        ...
        recyler_cart!!.layoutManager =layoutManager
        recyler_cart!!.addItemDecoration(DividerItemDecoration(this,layoutManager.orientation))
